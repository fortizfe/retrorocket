import { UnifiedExportOptions, UnifiedExportData, ExportFormat, SortOrder } from '@/features/boards/types/export';
import type { ExportOptions as PdfExportOptions } from '@/features/boards/export/services/pdfExportService';
import type { TxtExportOptions } from '@/features/boards/export/services/txtExportService';
import type { DocxExportOptions } from '@/features/boards/export/services/docxExportService';
...
export class UnifiedExportService {
    ...
    private async exportToPdf(data: UnifiedExportData, options: UnifiedExportOptions): Promise<void> {
        ...
        const { exportRetrospectiveToPdf } = await import('@/features/boards/export/services/pdfExportService');
    ...
    private async exportToTxt(data: UnifiedExportData, options: UnifiedExportOptions): Promise<void> {
        ...
        console.log(`Advanced facilitator features: Sentiment badges=${options.includeSentimentBadges}, Team mood=${options.includeTeamMoodAnalysis}`);
        const { exportRetrospectiveToTxt } = await import('@/features/boards/export/services/txtExportService');
    ...
    private async exportToDocx(data: UnifiedExportData, options: UnifiedExportOptions): Promise<void> {
        ...
        console.log(`Advanced facilitator features: Sentiment badges=${options.includeSentimentBadges}, Team mood=${options.includeTeamMoodAnalysis}`);
        const { exportRetrospectiveToDocx } = await import('@/features/boards/export/services/docxExportService');
