...
export { default as FacilitatorMenuTabs } from '@/features/boards/facilitator/components/FacilitatorMenuTabs';
export { default as ControlsTab } from '@/features/boards/facilitator/components/ControlsTab';
