        ...
        return (
            <div className="text-center p-8">
                ...
                <div className="flex items-center justify-center gap-2">
                    <div className="w-2 h-2 bg-info-fg rounded-full animate-bounce"></div>
                    <div className="w-2 h-2 bg-info-fg rounded-full animate-bounce delay-100"></div>
                    <div className="w-2 h-2 bg-info-fg rounded-full animate-bounce delay-200"></div>
                </div>
            </div>
        );
    }
