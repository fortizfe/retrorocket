            ...
            {langs.map((lng) => {
                ...
                return (
                    <button
                        ...
                        aria-checked={active}
                        onClick={() => change(code)}
                        className="w-full flex items-center justify-between gap-3 px-4 py-2 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
                    >
