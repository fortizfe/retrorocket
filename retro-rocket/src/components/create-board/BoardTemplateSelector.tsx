...
import { TemplateId, BOARD_TEMPLATES, ACTION_COLUMN } from '../../templates/boardTemplates';
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="pr-8">
                                ...
                                {/* Action Button */}
                                <div
                                    className={`w-full mt-3 py-2 px-4 rounded-lg text-sm font-medium transition-colors text-center ${isSelected
                                ...
                                >
                                    {isSelected ? (
                                        <span className="flex items-center justify-center gap-2">
                                            ...
                                            {t('createBoard.selectTemplate.defaultSelected')}
                                        </span>
                                    ) : (
                                        t('createBoard.selectTemplate.choose')
                                    )}
                                </div>
                            </div>
                        </motion.label>
