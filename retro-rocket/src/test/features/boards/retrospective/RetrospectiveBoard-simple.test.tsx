...
vi.mock('@/features/boards/clustering/components/GroupableColumn', () => ({
    default: ({ column }: any) => (
...
vi.mock('@/features/boards/retrospective/components/ActionItemsColumn', () => ({
...
vi.mock('@/features/boards/retrospective/hooks/useOptimizedCards', () => ({
    useOptimizedCards: () => ({
        cards: [],
        cardsByColumn: { 'helped': [], 'hindered': [], 'improve': [] },
        loading: false,
...
vi.mock('@/features/boards/clustering/hooks/useCardGroups', () => ({
    useCardGroups: () => ({
        groups: [],
        createGroup: vi.fn(),
        disbandGroup: vi.fn(),
...
vi.mock('@/features/boards/retrospective/hooks/useActionItems', () => ({
    useActionItems: () => ({
        actionItems: [],
        loading: false,
        error: null,
...
vi.mock('@/features/boards/retrospective/hooks/useRetrospectiveColumns', () => ({
...
// Mock sentiment hook
vi.mock('@/features/boards/sentiment/hooks/useSentiment', () => ({
    useSentiment: () => ({
        isEnabled: false,
        sentiment: null,
        analysis: null,
