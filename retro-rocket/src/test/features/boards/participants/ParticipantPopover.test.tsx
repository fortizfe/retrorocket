...
import ParticipantPopover from '@/features/boards/participants/components/ParticipantPopover';
...
vi.mock('@/features/boards/participants/components/ParticipantList', () => ({
