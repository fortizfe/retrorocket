...
import DraggableCard from '../../../components/retrospective/DraggableCard';
import { Card as CardType, CardColor, EmojiReaction, Like } from '../../../types/card';
...
vi.mock('../../../components/retrospective/LikeButton', () => ({
