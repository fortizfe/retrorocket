...
describe('CardService', () => {
    ...
    describe('createCard', () => {
        ...
        it('should handle creation errors gracefully', async () => {
            ...
            await expect(createCard(cardInput)).rejects.toThrow('Firebase error');
        });
    ...
    describe('updateCard', () => {
        it('should update card with new data and timestamp', async () => {
            ...
            expect(doc).toHaveBeenCalledWith(expect.anything(), 'card-id');
    ...
    describe('deleteCard', () => {
        ...
        it('should handle deletion errors', async () => {
            ...
            await expect(deleteCard('card-id')).rejects.toThrow('Deletion failed');
        });
    });
    ...
    describe('voteCard', () => {
        ...
        it('should handle voting errors', async () => {
            ...
            await expect(voteCard('card-id', true)).rejects.toThrow('Vote failed');
        });
    });
});
